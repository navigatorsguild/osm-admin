...
use crate::import::table_data_writer::TableDataWriter;
...
impl TableDataWriters {
    pub(crate) fn new(template_mapping: JsonValue, output_path: &PathBuf) -> Result<Self, osm_error::GenericError> {
    ...
    pub(crate) fn flush_buffers(&mut self) -> Result<(), GenericError> {
    ...
    pub(crate) fn log(&self) {
        // Nodes
        log::info!("Template mapping: {} -> {}", self.nodes.get_table_name(), self.nodes.get_file_name());
        log::info!("Template mapping: {} -> {}", self.node_tags.get_table_name(), self.node_tags.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_nodes.get_table_name(), self.current_nodes.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_node_tags.get_table_name(), self.current_node_tags.get_file_name());

        // Ways
        log::info!("Template mapping: {} -> {}", self.ways.get_table_name(), self.ways.get_file_name());
        log::info!("Template mapping: {} -> {}", self.way_nodes.get_table_name(), self.way_nodes.get_file_name());
        log::info!("Template mapping: {} -> {}", self.way_tags.get_table_name(), self.way_tags.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_ways.get_table_name(), self.current_ways.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_way_nodes.get_table_name(), self.current_way_nodes.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_way_tags.get_table_name(), self.current_way_tags.get_file_name());

        // Relations
        log::info!("Template mapping: {} -> {}", self.relations.get_table_name(), self.relations.get_file_name());
        log::info!("Template mapping: {} -> {}", self.relation_members.get_table_name(), self.relation_members.get_file_name());
        log::info!("Template mapping: {} -> {}", self.relation_tags.get_table_name(), self.relation_tags.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_relations.get_table_name(), self.current_relations.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_relation_members.get_table_name(), self.current_relation_members.get_file_name());
        log::info!("Template mapping: {} -> {}", self.current_relation_tags.get_table_name(), self.current_relation_tags.get_file_name());

        // Changesets
        log::info!("Template mapping: {} -> {}", self.changesets.get_table_name(), self.changesets.get_file_name());
        log::info!("Template mapping: {} -> {}", self.changeset_tags.get_table_name(), self.changeset_tags.get_file_name());

        // Users
        log::info!("Template mapping: {} -> {}", self.users.get_table_name(), self.users.get_file_name());
    }
}
